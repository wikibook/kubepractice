...
```bash
$ kubectl apply -f https://github.com/cert-manager/cert-manager/releases/download/v1.12.14/cert-manager.crds.yaml
```
...
$ helm install my-release --namespace cert-manager --version v1.12.14 jetstack/cert-manager
```
...
```console
$ kubectl delete -f https://github.com/cert-manager/cert-manager/releases/download/v1.12.14/cert-manager.crds.yaml
```
...
| `webhook.image.tag` | Webhook image tag | `v1.12.14` |
...
| `cainjector.image.tag` | cainjector image tag | `v1.12.14` |
...
| `acmesolver.image.tag` | acmesolver image tag | `v1.12.14` |
...
| `startupapicheck.image.tag` | startupapicheck image tag | `v1.12.14` |
